...
function slider(){
   ...
   /* $image = wp_get_attachment_image_src( get_post_thumbnail_id(4), 'single-post-thumbnail' ); */
    ...
    for($i = 0; $i<5; $i++){
        ...
        update_option('feature_author_' . $i, get_the_author_meta("display_name", $recent[$i][post_author]));
	...
	public function widget( $args, $instance ) {
        ...
        <div class = "featured_main">
            ...
            <span class = "featured_author">
                POSTED BY <?php echo get_option(feature_author_0); ?>
            </span>
        ...
        $(document).ready(function(){
            ...
            function nextpost(){
                    ...
                    if(i == 0){
                            ...
                            $("#feature_url_img").attr("href", "<?php echo get_option(feature_slider_url_1); ?>");
                            $(".featured_author").html("POSTED BY <?php echo get_option(feature_author_1); ?>");
                    ...
                    if(i == 1){
                            ...
                            $("#feature_url_img").attr("href", "<?php echo get_option(feature_slider_url_2); ?>");
                            $(".featured_author").html("POSTED BY <?php echo get_option(feature_author_2); ?>");
                    ...
                    if(i == 2){
                            ...
                            $("#feature_url_img").attr("href", "<?php echo get_option(feature_slider_url_3); ?>");
                            $(".featured_author").html("POSTED BY <?php echo get_option(feature_author_3); ?>");
                    ...
                    if(i == 3){
                            ...
                            $("#feature_url_img").attr("href", "<?php echo get_option(feature_slider_url_4); ?>");
                            $(".featured_author").html("POSTED BY <?php echo get_option(feature_author_4); ?>");
                    ...
                    if(i == 4){
                            ...
                            $("#feature_url_img").attr("href", "<?php echo get_option(feature_slider_url_0); ?>");
                            $(".featured_author").html("POSTED BY <?php echo get_option(feature_author_0); ?>");
